...
function initAttachedModals() {
  ...
  modals.push(new ModalAttached(modalContactsArgs));
  modals.push(new ModalAttached(modalUserArgs));
  modals.push(new ModalAttached(modalCartArgs));

  return modals;
}


export default initAttachedModals;
